        ...
        <MobileLayout>
            <div className="min-h-screen bg-white">
                ...
                <div className="p-5 space-y-5 pb-24">
                    <div className="rounded-[2rem] border border-black/[0.04] bg-white p-5 shadow-sm">
                        ...
                        <>
                            ...
                            {selectedBooking && (
                                <motion.div
                                    ...
                                    className="rounded-[2rem] border border-black/[0.04] bg-gray-50/70 p-5 space-y-3"
                                >
                                            ...
                                            <div className="mt-3 space-y-3">
                                                {[...selectedBooking.issues].slice(-3).reverse().map((issue, index) => (
                                                    <div key={issue._id || `${issue.type}-${index}`} className="rounded-xl bg-gray-50 px-3 py-3">
                                                        <div className="flex items-center justify-between gap-3">
                                                            <p className="text-[10px] font-black uppercase text-black">{issue.type || 'Issue'}</p>
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    {ISSUE_OPTIONS.map((option) => (
                                        <button
                                            ...
                                            className={`rounded-2xl border px-3 py-3 text-[10px] font-black uppercase tracking-[0.14em] transition-all ${issueType === option.id ? 'border-brand bg-brand/10 text-brand' : 'border-black/[0.06] bg-gray-50 text-black/50'}`}
                                        >
                                            {option.label}
                                        </button>
                                    ))}
                            ...
                            <div className="space-y-3">
                                ...
                                <textarea
                                    ...
                                    className="w-full rounded-2xl border border-black/[0.06] bg-gray-50 px-4 py-4 text-[11px] font-bold tracking-tight text-black outline-none focus:border-brand/20"
                                />
                            </div>
