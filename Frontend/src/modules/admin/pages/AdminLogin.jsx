...
const AdminLogin = () => {
    ...
    const handleLogin = (e) => {
        ...
        if (!user) {
            setError('Invalid System ID or Passcode. Try: admin@hoora.in / admin123');
            return;
        }
        setLoading(true);
        setTimeout(() => {
        ...
        <div className="min-h-screen bg-[#0F172A] flex flex-col items-center justify-center p-6 relative overflow-hidden font-sans">
            ...
            >
                ...
                <div className="flex flex-col items-center text-center mb-12">
                    ...
                    <h1 className="text-4xl font-black text-white italic tracking-tighter uppercase leading-none">Hoora <br /><span className="text-brand">Infrastructure</span></h1>
