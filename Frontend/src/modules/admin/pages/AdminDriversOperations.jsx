...
const AdminDriversOperations = () => {
    ...
    return (
        ...
        >
            ...
            {/* ── MAIN WORKSPACE ── */}
            <SectionCard
                title={operationsTab === 'drivers' ? "Active Fleet Deployment" : "Verification Pipeline"}
                actions={
                    <div className="flex items-center gap-2">
                        <StatusTabs 
                            tabs={[
                                { label: 'Active Fleet', value: 'drivers' },
                                { label: 'Verification', value: 'verification', count: drivers.filter(d => ['pending', 'PENDING'].includes(d.status)).length }
                            ]}
                            ...
                            >
                                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                                    ...
                                    <div className="flex items-center justify-end gap-3">
                                        ...
                                        <button 
                                            onClick={() => onApprove(driver._id || driver.id)}
