        ...
        return (
            <MobileLayout hideNav>
                <div className={`flex flex-col items-center justify-center min-h-screen px-6 text-center transition-colors duration-300 ${isDarkMode ? 'bg-[#0A0F0D]' : 'bg-[#FAF6EB]'}`}>
                    ...
                    <button onClick={() => navigate('/')} className={`mt-12 w-full h-16 rounded-2xl font-black uppercase tracking-[0.2em] text-[12px] shadow-2xl ${isDarkMode ? 'bg-white text-black' : 'bg-black text-white'
    ...
    return (
        <MobileLayout hideNav>
            <div className={`min-h-screen transition-colors duration-300 ${isDarkMode ? 'bg-[#0A0F0D]' : 'bg-[#FAF6EB]'}`}>
                                ...
                                <div className="px-5 pt-5 pb-4 flex items-center justify-between">
                                    ...
                                    <div className="flex gap-1.5">
                                        <button
                                            ...
                                            className={`w-11 h-11 border backdrop-blur-md rounded-xl flex items-center justify-center active:scale-95 transition-all ${isDarkMode ? 'bg-white/[0.03] border-white/10 text-white/20' : 'bg-black/[0.03] border-black/10 text-black/20'
                                                } hover:text-[#F59E0B]`}
                                        ...
                                        <button
                                            ...
                                            className={`w-11 h-11 rounded-xl flex items-center justify-center active:scale-90 transition-transform ${isDarkMode ? 'bg-white/10 text-white' : 'bg-black/10 text-black'
                                                }`}>
                ...
                {/* ── CTA Footer ── */}
                <div className={`fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-md border-t px-6 py-6 pb-12 z-50 backdrop-blur-xl transition-colors duration-300 ${isDarkMode ? 'bg-[#0A0F0D]/90 border-white/5' : 'bg-white/95 border-black/5'
                    }`}>
                    {liveBooking.status === 'completed' ? (
                        <div className="space-y-5">
                            ...
                            <motion.button
                                ...
                                className={`w-full h-16 rounded-2xl font-black text-[12px] uppercase tracking-[0.2em] shadow-2xl flex items-center justify-center gap-3 ${isDarkMode ? 'bg-white text-black shadow-black/50' : 'bg-black text-white shadow-black/10'
                                    }`}
                            >
