        ...
        <DriverLayout title="Address">
            <div className="px-6 py-6 pb-28 space-y-5">
                <div className="rounded-[2rem] border border-black/[0.05] bg-white/5 p-5 shadow-[0_18px_40px_rgba(15,23,42,0.08)]">
                    ...
                    <h2 className="text-[20px] font-black text-white uppercase tracking-tight leading-tight mt-2">Set Operational Address</h2>
                ...
                <form onSubmit={handleSave} className="rounded-[1.5rem] border border-black/[0.06] bg-white/5 p-4 space-y-3">
                    <label className="block">
                        <span className="block text-[9px] font-black text-black/30 uppercase tracking-widest mb-1.5">Street / Locality</span>
                        <div className="h-11 border border-white/10 rounded-xl px-3 flex items-center gap-2">
                            <Home size={14} className="text-white/40" />
                            <input
                                value={form.street}
                                onChange={(event) => setForm((prev) => ({ ...prev, street: event.target.value }))}
                                required
                                className="w-full h-full outline-none text-[12px] font-black text-white"
                            />
                        </div>
                    </label>
                    ...
                    <button
                        type="submit"
                        disabled={saving}
                        className="w-full h-11 rounded-xl bg-brand text-white text-[10px] font-black uppercase tracking-wider flex items-center justify-center gap-2"
                    >
