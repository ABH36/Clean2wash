        ...
        <VendorLayout title="Fleet Ops" subtitle="Manage your mobile service units & field agents">
            <div className="space-y-8">
                ...
                <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
                    <div className="flex items-center gap-2 bg-background p-1 rounded-2xl border border-gray-100/10">
                        <button
                            ...
                            className={`px-6 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all flex items-center gap-2 ${activeTab === 'personnel' ? 'bg-surface text-brand shadow-sm' : 'text-content-subtle hover:text-content'}`}
                        >
                            <Users size={14} /> Personnel
                        </button>
                        <button
                            onClick={() => setActiveTab('vehicles')}
                            className={`px-6 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all flex items-center gap-2 ${activeTab === 'vehicles' ? 'bg-surface text-brand shadow-sm' : 'text-content-subtle hover:text-content'}`}
                        >
                ...
                <AnimatePresence mode="wait">
                    {loading ? (
                        <div className="py-24 flex flex-col items-center gap-4 bg-gray-50/5 rounded-[3rem] border border-gray-100/5">
                        ...
                        >
                            {staffList.length > 0 ? staffList.map((staff) => (
                                <motion.div
                                    key={staff.id}
                                    whileHover={{ y: -5 }}
                                    className="bg-surface rounded-[2.5rem] border border-gray-100/10 p-8 shadow-soft space-y-7 relative group overflow-hidden transition-all active:scale-[0.98]"
                                >
                                    ...
                                    <div className="flex items-center gap-5 relative z-10">
                                        <div className="w-16 h-16 rounded-2xl bg-background border border-gray-100/10 flex items-center justify-center text-brand relative shadow-inner">
                                            <Users size={28} />
                                            <div className="absolute -bottom-1 -right-1 w-6 h-6 bg-green-500 rounded-lg border-4 border-surface flex items-center justify-center shadow-sm">
                                    ...
                                    <div className="space-y-3.5 pt-5 border-t border-gray-100/5 relative z-10">
                                        <div className="flex items-center justify-between text-content-subtle">
                                            <div className="flex items-center gap-3">
                                                <div className="w-7 h-7 bg-background rounded-lg border border-gray-100/5 flex items-center justify-center">
                                ...
                                <div className="col-span-full py-24 flex flex-col items-center gap-4 text-center bg-surface border border-dashed border-gray-100/20 rounded-[3rem] shadow-soft">
                                    <div className="w-16 h-16 bg-background rounded-[1.5rem] flex items-center justify-center mx-auto text-content-subtle/10 border border-gray-100/10 shadow-inner mb-2">
                                        <Users size={32} />
                                    </div>
                                    <div>
                        ...
                        <motion.div
                            ...
                            className="bg-surface rounded-[2.5rem] border border-gray-100/10 shadow-soft overflow-hidden transition-all pb-24 md:pb-0"
                        >
                            <div className="admin-table-container overflow-x-auto">
                                <table className="w-full text-left border-collapse">
                                    <thead>
                                        <tr className="bg-background/50 border-b border-gray-100/5">
                                            ...
                                            <tr key={v.id} className="group hover:bg-background/40 transition-all font-black relative active:scale-[0.995]">
                                                <td className="px-8 py-6">
                                                    <div className="flex items-center gap-4">
                                                        <div className="w-12 h-12 rounded-2xl bg-background border border-gray-100/10 flex items-center justify-center text-brand shadow-inner group-hover:scale-110 transition-transform">
                                                            <Truck size={20} />
                                                        </div>
                                                ...
                                                <td className="px-8 py-6">
                                                    <div className="inline-flex items-center px-3 py-1.5 bg-background border border-gray-100/10 rounded-xl shadow-sm">
                                                ...
                                                <td className="px-8 py-6">
                                                    <div className="flex items-center gap-2.5">
                                                        <div className={`w-2 h-2 rounded-full shadow-sm ${v.status === 'Available' ? 'bg-green-500 animate-pulse' : 'bg-amber-500'}`} />
                                                ...
                                                <td className="px-8 py-6 text-right">
                                                    <div className="flex justify-end gap-3 md:opacity-0 group-hover:opacity-100 transition-all">
                                                        <button onClick={() => handleOpenDrawer(v)} className="w-10 h-10 bg-background border border-gray-100/10 rounded-xl flex items-center justify-center text-content-subtle hover:text-brand hover:border-brand/40 shadow-sm transition-all"><Edit3 size={16} /></button>
                                                        <button onClick={() => handleDeleteVehicle(v.id)} className="w-10 h-10 bg-background border border-gray-100/10 rounded-xl flex items-center justify-center text-content-subtle hover:text-red-500 hover:border-red-500/40 shadow-sm transition-all"><Trash2 size={16} /></button>
                                                    </div>
                                                </td>
                                            </tr>
                                        ))}
