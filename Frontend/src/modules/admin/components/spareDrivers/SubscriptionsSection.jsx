    ...
    <div className="space-y-3">
        <div className="bg-white border border-gray-100 rounded-[1rem] px-4 py-3.5 flex items-center justify-between gap-3 flex-wrap">
            ...
            <div className="flex items-center gap-2 flex-wrap">
                ...
                <button
                    ...
                    className="flex items-center gap-2 h-9 px-4 bg-black text-white rounded-lg text-[10px] font-black uppercase hover:bg-brand hover:text-black transition-colors"
                >
                    <Plus size={13} />
                    New Plan
                </button>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-3">
            {plansLoading ? (
                ...
                <div key={plan._id} className="bg-white border border-gray-100 rounded-[1rem] p-4 space-y-3.5">
                    <div className="flex items-start justify-between gap-3">
                        ...
                        <div className="flex items-center gap-2">
                            <button
                                ...
                                className="h-9 w-9 bg-black text-white rounded-lg flex items-center justify-center hover:bg-brand hover:text-black transition-colors"
                            >
                                <Edit2 size={14} />
                            </button>
                            <button
